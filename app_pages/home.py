...
def render() -> None:
    ...
    modules = [
        ...
        },
        {
            ...
            "outputs": "Athena/Phoenix payoff, worst-of basket, Monte Carlo proxy, barrier risk, Excel report.",
            "status": "Live",
        },
        {
            "title": "Portfolio Risk",
            "desk_use": "AM/risk portfolio review.",
            "outputs": "VaR, CVaR, drawdown, risk contribution, stress scenarios, R analytics, Excel report.",
            "status": "Live",
        },
        {
            "title": "Cross-Asset Dashboard",
            "desk_use": "Morning market monitoring.",
            "outputs": "Rates, financing, structured products, portfolio risk, stress scenarios, risk heatmap.",
            "status": "Live",
        },
    ]
