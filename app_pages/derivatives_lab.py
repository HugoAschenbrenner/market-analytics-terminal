...
from components.interactive_greeks import render_interactive_greeks


def render(state):
    tab_keys=['vanilla','greeks','volatility','structured','workshop','interactive_greeks']
    ...
    if tabs[5].open:
        with tabs[5]:render_interactive_greeks(state)
